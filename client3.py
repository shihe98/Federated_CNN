...
def train(weights):
    ...
    with open("duibi_client3_log.txt", "a") as f:
...
if __name__ == "__main__":
    ...
    with open("duibi_client3_log.txt", "w") as f:
        f.write('duibi_client3_log\n')
        f.write('数据量333\n')
    for i in range(200):
        print(i, "轮循环开始")
        with open("duibi_client3_log.txt", "a") as f:
        ...
        client2 = Client2("192.168.159.1", 6001)
        t2=time.time()
        with open("duibi_client3_log.txt", "a") as f:
        ...
        t1=time.time()
        client4 = Client_server("192.168.159.1", 6001,weights)
        t2=time.time()
        with open("duibi_client3_log.txt", "a") as f:
